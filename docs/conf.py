...
copyright = '2012, Zope Foundation Contributors <zope-dev@zope.org>'
...
latex_documents = [
    ('index',
     ...
     'Zope Foundation Contributors \\textless{}zope-dev@zope.org'
     '\\textgreater{}',
     'manual'),
]
...
man_pages = [
    ('index', 'zopesecurity', 'zope.security Documentation',
     ['Zope Foundation Contributors <zope-dev@zope.org>'], 1)
]
...
intersphinx_mapping = {
    ...
    'zopeproxy': ('https://zopeproxy.readthedocs.io/en/latest', None),
...
extlinks = {
    'issue': (
        ...
        'issue #'),
    'pr': (
        'https://github.com/zopefoundation/zope.security/pull/%s',
        'pull request #')}
